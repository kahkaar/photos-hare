...
__all__ = ["save_jpg", "validate_jpg_signature", "remove_exif_data"]


def save_jpg(data, post_id):
    clean_data = remove_exif_data(data)
...
def validate_jpg_signature(data):
    soi = data[:2]
    eoi = data[-2:]
